...
class IsolationForestEncoder(EmbetterBase):
    """
    ...
    **Usage**:
    ...
    def transform(self, X, y=None):
        ...
        if self.forest_ is None:
            raise ValueError("IsolationForestEncoder must be fitted before transform")
        ...
        # You could also keep them separate if needed
